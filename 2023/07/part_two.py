...
class Hand:
    ...
    def classify_hand(self, string: str) -> int:
        ...
        if len(letters) == 1:
            ...
            if jokers_count >= 1:
                hand_type = 7 # five-of-a-kind including jokers
            else:
                if values[-1] == 4:
            ...
            if jokers_count >= 2:
                hand_type = 6 # four-of-a-kind including jokers
            elif jokers_count == 1:
                if values[-1] == 3:
                    hand_type = 6 # four-of-a-kind including joker
                elif values[-1] == 2:
                    hand_type = 5 # full-house including joker
            else:
                if values[-1] == 3:
            ...
            if jokers_count >= 1:
                hand_type = 4 # three-of-a-kind including jokers
            else:
                hand_type = 2 # one-pair
        elif len(letters) == 5:
            if jokers_count == 1:
                hand_type = 2 # one-pair including joker
            else:
